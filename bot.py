...
def build_dynamic_cafe_simple(title: str, body: str, *, sport: str = "", seed: str = "") -> str:
    ...
    outro_pool_by_theme = {
        "세트피스": [
            "정리하면 {matchup}은 세트피스 한두 장면이 승부처가 될 수 있다.",
            "끝으로 {matchup}은 세트피스 수비/공격 완성도가 결과를 가를 가능성이 크다.",
            "결국 {matchup}은 세트피스에서 기회를 더 많이 쌓는 쪽이 유리하다.",
            "{matchup}은 코너킥·프리킥 한 번의 디테일이 점수로 이어질 수 있다.",
        ],
        "압박": [
            "요약하면 {matchup}은 압박 타이밍과 라인 간격이 포인트다.",
            "결국 {matchup}은 중원 압박이 먼저 먹히는 쪽이 흐름을 잡을 수 있다.",
            "마지막으로 {matchup}은 압박 회피와 전진 패스의 정확도가 관건이다.",
            "{matchup}은 강하게 눌렀을 때의 세컨볼 대응이 승부를 가를 수 있다.",
        ],
        "전환": [
            "정리하면 {matchup}은 공수 전환 속도에서 차이가 날 수 있다.",
            "결국 {matchup}은 전환 한 번에 수비 라인이 무너질 수 있어 실점 관리가 중요하다.",
            "끝으로 {matchup}은 전환 상황에서 뒷공간 대응이 승부처다.",
            "{matchup}은 전환 국면에서 실수를 줄이는 쪽이 유리하다.",
        ],
        "수비": [
            "마무리로 {matchup}은 실점 관리와 박스 안 대응이 핵심이다.",
            "결국 {matchup}은 수비 조직력 유지가 먼저 시험대에 오른다.",
            "정리하면 {matchup}은 라인 컨트롤과 커버 타이밍이 승부처가 될 수 있다.",
            "{matchup}은 수비 실수 한 번이 그대로 점수로 이어질 수 있다.",
        ],
        "역습": [
            "정리하면 {matchup}은 역습 한 방의 완성도가 승부를 가를 수 있다.",
            "끝으로 {matchup}은 역습 전개 속도와 마무리의 정확도가 관건이다.",
            "결국 {matchup}은 역습 찬스를 더 효율적으로 살리는 쪽이 유리하다.",
            "{matchup}은 역습 상황에서 첫 패스 선택이 승부처가 될 수 있다.",
        ],
        "피지컬": [
            "마지막으로 {matchup}은 피지컬 경합과 세컨볼 싸움에서 흐름이 갈릴 수 있다.",
            "정리하면 {matchup}은 제공권·경합에서 우위가 승부를 가를 가능성이 크다.",
            "결국 {matchup}은 강도 높은 몸싸움에서 버티는 쪽이 유리하다.",
            "{matchup}은 후반 체력 싸움에서 격차가 벌어질 수 있다.",
        ],
    }

    outro_pool_generic = [
        "정리하면 {matchup}은 운영 디테일에서 승부가 갈릴 수 있다.",
        "결국 {matchup}은 한두 장면의 완성도가 결과를 좌우할 수 있다.",
        "마무리로 {matchup}은 실수 관리가 중요하다.",
        "{matchup}은 후반 운영에서 차이가 날 수 있다.",
        "{matchup}은 흐름을 먼저 잡는 팀이 유리하다.",
        "끝으로 {matchup}은 결정력과 실점 관리가 함께 중요하다.",
    ]
