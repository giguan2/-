...
✅ 추세: 홈 공격력 상승 + 애틀랜타 백투백 체력 부담""",
    ...
    "배구": [
                {
            "id": "vball_1",
            "title": "V리그 - 11.14 우리카드 vs 한국전력",
            "summary": """📌 우리카드 vs 한국전력 분석 요약

✔️ 팀 분위기 & 최근 흐름
우리카드: 4연패 중. 아라우조가 15득점으로 분전했지만 공격 지원 부족, 세터와의 호흡 문제, 서브·리시브 불안까지 겹치며 전체적인 경기력 하락. 공격 패턴이 단조로워 상대 블로킹에 쉽게 막히는 흐름. 홈에서는 1승1패.
...
✅ 추세: 우리카드 4연패 흐름 + 한국전력 공격 라인 우세""",
                        ...
                        {
            "id": "vball_2",
            "title": "V리그 - 11.14 IBK기업은행 vs GS칼텍",
            "summary": """📌 IBK기업은행 vs GS칼텍스 분석 요약

✔️ 팀 분위기 & 최근 흐름
IBK기업은행: 4연패 흐름. 빅토리아가 38득점으로 분전했고 최정민도 블로킹 6개 포함 16득점으로 활약했지만, 주전 세터 김하경이 발목 인대 파열로 들것 이송. 이소영 시즌 아웃까지 겹치며 세터·공격 라인 동시 붕괴. 박은서·최연진 세터 체제로 운영해야 하는 어려운 상황. 홈에서도 1승2패로 흐름 좋지 않음.
