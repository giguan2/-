...
클리블랜드: 최근 6경기 5승. 주전 결장에도 마이애미 원정 설욕 성공. 홈 3연승 포함 4승1패로 안정감.
...
클리블랜드 캐벌리어스:
대리어스 갈랜드(G) 11월13일 복귀 예정
제일런 타이슨(G) 11월13일 복귀 예정
에반 모블리(C) 11월13일 복귀 예정
도노반 미첼(G) 11월13일 복귀 예정
맥스 스트러스(G) 12월1일 복귀 예정
...
✔️ 팀 분위기 & 최근 흐름
피닉스: 4연승 + 최근 7경기 6승1패 흐름. 부커·굿윈·그레이슨 앨런이 꾸준히 득점하며 경기 주도. 3쿼터 압박 수비로 흐름을 잡는 패턴이 강점. 홈에서도 5승1패로 강세.
인디애나: 5연패 + 원정 6연패. 시아캄이 분전했지만 핵심 전력 부재로 공격·수비 모두 붕괴. 조직력 완전히 무너진 상태.
...
✔️ 부상자
피닉스 선즈:
제일런 그린(G) 12월18일 복귀 예정

인디애나 페이서스:
캠 존스(G) 12월3일 복귀 예정
베네딕트 마서린(G) 11월15일 복귀 예정
조니 퍼피(G) 11월15일 복귀 예정
퀸튼 잭슨(G) 11월15일 복귀 예정
오비토핀(F) 2월2일 복귀 예정
